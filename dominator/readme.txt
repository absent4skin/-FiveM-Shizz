...
Dashboard	|	Hýz göstergesi
Tuning Parts	|	Modifiye parçalarý
Lights Work	|	Farlar sorunsuz
Dirt Effect	| 	Kir efekti
Breakable Glass |	Camlar kýrýlýyor
...
dominator.yft
dominator_hi.yft
>>> x64e.rpf\levels\gta 5\vehicles.rpf
...
dom_spoiler_2.yft
dom_vents.yft
>>> x64i.rpf\levels\gta5\vehiclemods\dominator_mods.rpf
...
Dominator settings;
    ...
    <Item>
      <modelName>dominator</modelName>
      <txdName>dominator</txdName>
      <handlingId>DOMINATOR</handlingId>
      <gameName>DOMINATO</gameName>
      ...
      <maxNum value="20" />
      <flags>FLAG_SPAWN_ON_TRAILER FLAG_PARKING_SENSORS FLAG_AVERAGE_CAR FLAG_RECESSED_HEADLIGHT_CORONAS FLAG_HAS_INTERIOR_EXTRAS FLAG_HAS_LIVERY</flags>
